...
function analyzeSalesData(data, options) {
    ...
    data.purchase_records.forEach(record => { // Чек 
            ...
            record.items.forEach(item => {
                ...
                const itemProfit = revenue - cost // Посчитать прибыль: выручка минус себестоимость  
                seller.profit += itemProfit // Увеличить общую накопленную прибыль (profit) у продавца
